...
(function($, window, undefined) {
    ...
    $.DLMenu.prototype = {
        _init: function(options) {
            ...
            this.transEndEventName = transEndEventNames[Modernizr.prefixed("transition")] + ".dlmenu", this.supportAnimations = Modernizr.cssanimations, this.supportTransitions =
        ...
        _config: function() {
            ...
            this.$close = this.$menu.find("li.menuClose");
        ...
        _initEvents: function() {
            ...
            this.$close.click(".menuClose", function() {
                self._closeMenu();
                return false
            });
